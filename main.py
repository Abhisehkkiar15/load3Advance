...
cpimg = "https://i.ibb.co/spTsXjgs/gfksopgkdogm.jpg"  
...
AUTH_CHANNELS = [-1002795399364]  # Add more channel IDs here
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/Final_piece") ],
                    [
                    InlineKeyboardButton("🔔ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🔔" ,url="https://t.me/Final_piece") ],
                    [
                    InlineKeyboardButton("🦋ғᴏʟʟᴏᴡ ᴜs🦋" ,url="https://t.me/Final_piece")                              
                ],           
            ]
      )
...
async def edit_txt(client, message: Message):
    ...
    try:
        await message.reply_document(
            ...
            caption="📥**𝗘𝗱𝗶𝘁𝗲𝗱 𝗕𝘆 ➤ ALL CLASSES MORENA**"
        )
    except Exception as e:
...
async def upload(bot: Client, m: Message):
    ...
    credit = "️[ALL CLASSES MORENA](https://t.me/Final_piece)"
    if raw_text3 == '1':
        CR = '[ALL CLASSES MORENA](https://t.me/Final_piece)'
    elif raw_text3:
        try:
    ...
    await editable.edit("𝗡𝗼𝘄 𝗦𝗲𝗻𝗱 𝗧𝗵𝗲 𝗧𝗵𝘂𝗺𝗯 𝗨𝗿𝗹 𝗘𝗴 » https://i.ibb.co/spTsXjgs/gfksopgkdogm.jpg\n\n𝗢𝗿 𝗜𝗳 𝗗𝗼𝗻'𝘁 𝗪𝗮𝗻𝘁 𝗧𝗵𝘂𝗺𝗯𝗻𝗮𝗶𝗹 𝗦𝗲𝗻𝗱 = 𝗻𝗼")
